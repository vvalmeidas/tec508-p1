...
\item 
void $\ast$ \hyperlink{main_8c_a336091df8abd6fc9a95991073f7c362a}{emalloc} (size\+\_\+t n)
\begin{DoxyCompactList}\small\item\em Realiza alocação dinâmica para um número de bytes. \end{DoxyCompactList}\item 
...
double \hyperlink{main_8c_a8023ea9325c50029e9715fa369bece9d}{rand\+\_\+range} (double min, double max)
\begin{DoxyCompactList}\small\item\em Gera números reais aleatórios. \end{DoxyCompactList}\item 
void \hyperlink{main_8c_a6bad370adfe0a13f441d4a56f0348d2b}{initialize\+\_\+weights} (double $\ast$row)
\begin{DoxyCompactList}\small\item\em Inicializa o vetor de pesos. \end{DoxyCompactList}\item 
void \hyperlink{main_8c_a25bf5b173ca724971a97dc59d17d1fea}{read\+\_\+data\+\_\+and\+\_\+labels} (F\+I\+LE $\ast$ifp, double $\ast$$\ast$data\+\_\+testing, double $\ast$$\ast$data\+\_\+training, int $\ast$labels\+\_\+testing, int $\ast$labels\+\_\+training)
\begin{DoxyCompactList}\small\item\em Realiza a leitura completa do arquivo .csv de entrada. \end{DoxyCompactList}\item 
void \hyperlink{main_8c_a47ab626a89f4afbba016e7b209b5e702}{save\+\_\+results} (int epoch\+\_\+num, int $\ast$results, int $\ast$labels, int num\+\_\+images)
\begin{DoxyCompactList}\small\item\em Salva os resultados em arquivo. \end{DoxyCompactList}\item 
double \hyperlink{main_8c_ac30d1aca2764b4fe48d62d345d69f803}{hypothesis\+\_\+function} (double $\ast$row, double $\ast$weights)
\begin{DoxyCompactList}\small\item\em Realiza o cálculo da função hipótese. \end{DoxyCompactList}\item 
double \hyperlink{main_8c_a909cc976e53e21ebfffd03d0e85e3899}{gradient} (double $\ast$$\ast$data\+\_\+training, int $\ast$labels, double $\ast$all\+\_\+hypothesis, int c, double learning\+\_\+rate)
\begin{DoxyCompactList}\small\item\em Realiza o cálculo do gradiente descendente. \end{DoxyCompactList}\item 
void \hyperlink{main_8c_aa2c45710821cad281f23b388afb9f292}{update\+\_\+weights} (double $\ast$$\ast$data\+\_\+training, double $\ast$weights, double $\ast$all\+\_\+hypothesis, int $\ast$labels, double learning\+\_\+rate)
\begin{DoxyCompactList}\small\item\em Realiza a atualização dos pesos. \end{DoxyCompactList}\item 
double \hyperlink{main_8c_afd39c97dd05784e54fa201812cc1aba2}{cost\+\_\+function} (double $\ast$$\ast$data, double $\ast$weights, int $\ast$labels, int num\+\_\+images)
...
\subsection{Funções}
\mbox{\Hypertarget{main_8c_afd39c97dd05784e54fa201812cc1aba2}\label{main_8c_afd39c97dd05784e54fa201812cc1aba2}} 
...
{\footnotesize\ttfamily double cost\+\_\+function (\begin{DoxyParamCaption}\item[{double $\ast$$\ast$}]{data,  }\item[{double $\ast$}]{weights,  }\item[{int $\ast$}]{labels,  }\item[{int}]{num\+\_\+images }\end{DoxyParamCaption})}
...
{\em data} & dataset para o qual será calculado o custo \\
\hline
...
double custo resultante 
\end{DoxyReturn}
\mbox{\Hypertarget{main_8c_a336091df8abd6fc9a95991073f7c362a}\label{main_8c_a336091df8abd6fc9a95991073f7c362a}} 
\index{main.\+c@{main.\+c}!emalloc@{emalloc}}
\index{emalloc@{emalloc}!main.\+c@{main.\+c}}
\subsubsection{\texorpdfstring{emalloc()}{emalloc()}}
{\footnotesize\ttfamily void$\ast$ emalloc (\begin{DoxyParamCaption}\item[{size\+\_\+t}]{n }\end{DoxyParamCaption})}



Realiza alocação dinâmica para um número de bytes. 

Realiza a alocação dinâmica para um espaço de memória de acordo com o número de bytes informado.


\begin{DoxyParams}{Parâmetros}
{\em n} & número de bytes a serem alocados \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Retorna}
...
void$\ast$ ponteiro para o endereço de memória alocado 
\end{DoxyReturn}
\mbox{\Hypertarget{main_8c_a909cc976e53e21ebfffd03d0e85e3899}\label{main_8c_a909cc976e53e21ebfffd03d0e85e3899}} 
\index{main.\+c@{main.\+c}!gradient@{gradient}}
\index{gradient@{gradient}!main.\+c@{main.\+c}}
\subsubsection{\texorpdfstring{gradient()}{gradient()}}
{\footnotesize\ttfamily double gradient (\begin{DoxyParamCaption}\item[{double $\ast$$\ast$}]{data\+\_\+training,  }\item[{int $\ast$}]{labels,  }\item[{double $\ast$}]{all\+\_\+hypothesis,  }\item[{int}]{c,  }\item[{double}]{learning\+\_\+rate }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Retorna}
double valor de gradiente resultante 
\end{DoxyReturn}
\mbox{\Hypertarget{main_8c_ac30d1aca2764b4fe48d62d345d69f803}\label{main_8c_ac30d1aca2764b4fe48d62d345d69f803}} 
...
{\footnotesize\ttfamily double hypothesis\+\_\+function (\begin{DoxyParamCaption}\item[{double $\ast$}]{row,  }\item[{double $\ast$}]{weights }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Retorna}
double resultado da função hipotese 
\end{DoxyReturn}
\mbox{\Hypertarget{main_8c_a6bad370adfe0a13f441d4a56f0348d2b}\label{main_8c_a6bad370adfe0a13f441d4a56f0348d2b}} 
...
{\footnotesize\ttfamily void initialize\+\_\+weights (\begin{DoxyParamCaption}\item[{double $\ast$}]{row }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
obtém os argumentos, converte para int ou float e inicializa o número de épocas e a taxa de aprendizado \mbox{\Hypertarget{main_8c_a8023ea9325c50029e9715fa369bece9d}\label{main_8c_a8023ea9325c50029e9715fa369bece9d}} 
...
{\footnotesize\ttfamily double rand\+\_\+range (\begin{DoxyParamCaption}\item[{double}]{min,  }\item[{double}]{max }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Retorna}
double valor aleatório gerado 
\end{DoxyReturn}
\mbox{\Hypertarget{main_8c_a25bf5b173ca724971a97dc59d17d1fea}\label{main_8c_a25bf5b173ca724971a97dc59d17d1fea}} 
...
{\footnotesize\ttfamily void read\+\_\+data\+\_\+and\+\_\+labels (\begin{DoxyParamCaption}\item[{F\+I\+LE $\ast$}]{ifp,  }\item[{double $\ast$$\ast$}]{data\+\_\+testing,  }\item[{double $\ast$$\ast$}]{data\+\_\+training,  }\item[{int $\ast$}]{labels\+\_\+testing,  }\item[{int $\ast$}]{labels\+\_\+training }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parâmetros}
{\em ifp} & ponteiro para leitura de arquivo \\
\hline
...
realiza iteração para cada pixel que será lido \mbox{\Hypertarget{main_8c_a47ab626a89f4afbba016e7b209b5e702}\label{main_8c_a47ab626a89f4afbba016e7b209b5e702}} 
\index{main.\+c@{main.\+c}!save\+\_\+results@{save\+\_\+results}}
\index{save\+\_\+results@{save\+\_\+results}!main.\+c@{main.\+c}}
\subsubsection{\texorpdfstring{save\+\_\+results()}{save\_results()}}
{\footnotesize\ttfamily void save\+\_\+results (\begin{DoxyParamCaption}\item[{int}]{epoch\+\_\+num,  }\item[{int $\ast$}]{results,  }\item[{int $\ast$}]{labels,  }\item[{int}]{num\+\_\+images }\end{DoxyParamCaption})}
...
atualiza a matriz de confusão \mbox{\Hypertarget{main_8c_aa2c45710821cad281f23b388afb9f292}\label{main_8c_aa2c45710821cad281f23b388afb9f292}} 
...
{\footnotesize\ttfamily void update\+\_\+weights (\begin{DoxyParamCaption}\item[{double $\ast$$\ast$}]{data\+\_\+training,  }\item[{double $\ast$}]{weights,  }\item[{double $\ast$}]{all\+\_\+hypothesis,  }\item[{int $\ast$}]{labels,  }\item[{double}]{learning\+\_\+rate }\end{DoxyParamCaption})}
